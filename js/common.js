(function ($) {
  ...
  function systole() {
    ...
    var $warpEle = $(".history-date"),
      $targetA = $warpEle.find("h1 a,ul li dl dt a"),
      parentH,
      eleTop = [];
    ...
    setTimeout(function () {
      $warpEle.find("ul").children(":not('h1:first')").each(function (idx) {
      ...
      $warpEle.find("ul").children(":not('h1:first')").addClass("bounceInDown").css({
